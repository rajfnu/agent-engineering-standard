...
socio-economic status, nationality, personal appearance, race, caste, colour, religion, or
...
This project reviews technical work critically and directly. Critique the work, not the
person — "this rule has no failure case behind it" is fine; "you do not understand
software" is not.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported to the
maintainers through a GitHub issue marked private-request, or through GitHub's own
reporting tools. All complaints will be reviewed and investigated promptly and fairly.
...
contributions that are not aligned with this Code of Conduct, and may temporarily or
permanently ban any contributor for behaviour they deem inappropriate, threatening,
